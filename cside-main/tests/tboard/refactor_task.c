...
void app_main(void)
{
    ...
    arg_t set_args[3] = {arg1, arg2, arg3};
    ...
    if (!task_instance_set_args(task_inst, set_args)) {
        return;
    }
    ...
    set_args[2].type = DOUBLE_TYPE;
    set_args[2].val.dval = 3.0;
    /* Set args with wrong type */
    assert(task_instance_set_args(task_inst, set_args) == false);
    /* Set args with wrong nargs */
    set_args[2].type = INT_TYPE;
    set_args[2].val.ival = 3;
    set_args[2].nargs = 1;
    assert(task_instance_set_args(task_inst, set_args) == false);
