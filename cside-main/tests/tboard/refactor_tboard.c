...
void app_main(void)
{
    ...
    task_instance_t* il_task_inst = tboard_start_task(tboard, "inf_loop", 0, NULL, 0);
    ...
    arg_t* example_args[3];
    example_args[0] = &arg1;
    example_args[1] = &arg2;
    example_args[2] = &arg3;

    task_instance_t* task_inst = tboard_start_task(tboard, "example", 0, example_args, 3);
    ...
    arg_t* example_2_args_0[2];
    arg_t e2_arg1_0 = {.type = STRING_TYPE, .val.sval = "instance 0"};
    arg_t e2_arg2_0 = {.type = DOUBLE_TYPE, .val.dval = 1.0f};
    example_2_args_0[0] = &e2_arg1_0;
    example_2_args_0[1] = &e2_arg2_0;

    arg_t* example_2_args_1[2];
    arg_t e2_arg1_1 = {.type = STRING_TYPE, .val.sval = "instance 1"};
    arg_t e2_arg2_1 = {.type = DOUBLE_TYPE, .val.dval = 2.0f};
    example_2_args_1[0] = &e2_arg1_1;
    example_2_args_1[1] = &e2_arg2_1;

    arg_t* example_2_args_2[2];
    arg_t e2_arg1_2 = {.type = STRING_TYPE, .val.sval = "instance 2"};
    arg_t e2_arg2_2 = {.type = DOUBLE_TYPE, .val.dval = 3.0f};
    example_2_args_2[0] = &e2_arg1_2;
    example_2_args_2[1] = &e2_arg2_2;

    arg_t* example_2_args_3[2];
    arg_t e2_arg1_3 = {.type = STRING_TYPE, .val.sval = "instance 3"};
    arg_t e2_arg2_3 = {.type = DOUBLE_TYPE, .val.dval = 69.0f};
    example_2_args_3[0] = &e2_arg1_3;
    example_2_args_3[1] = &e2_arg2_3;

    arg_t* example_2_args_4[2];
    arg_t e2_arg1_4 = {.type = STRING_TYPE, .val.sval = "instance 4"};
    arg_t e2_arg2_4 = {.type = DOUBLE_TYPE, .val.dval = 1.420f};
    example_2_args_4[0] = &e2_arg1_4;
    example_2_args_4[1] = &e2_arg2_4;
    ...
    for (int i = 0; i < MAX_INSTANCES; i++) {
        tboard_start_task(tboard, "example_2", i, example_2_args[i], 2);
    }
